                                ...
                                <div class="box">
                                    ...
                                    <div id="collapse4" class="body">
                                        <table width="100%" class="table table-striped table-bordered table-hover" >
                                            ...
                                            ${message}
                                            <form:form action="thanhtich.htm" modelAttribute="student" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <form:input path="thanhtich" cssClass="form-control" type="hidden"/>
                                                </div>
                                                <div class="form-group">

                                                    <form:input path="kyluat" cssClass="form-control" type="hidden"/>

                                                    <input type="hidden" value="${student.thanhtich+1}" name="txtThanhtich"/>
                                                    <input type="hidden" value="${student.kyluat+1}" name="txtKyluat"/>
                                                </div>
                                                   <div class="form-group">
                                                    <label>Ngày đánh giá</label>
                                                    <form:input path="ngaydanhgia" cssClass="form-control"/>
                                                ...
                                                <div class="form-group text-center">
                                                    ...
                                                    <button name="btnCapNhat" class="btn btn-default"><a>Kỷ Luật</a></button>
                                                    <button name="btnKhen" class="btn btn-default"><a>Khen Thưởng</a></button>
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center">Thành Tích Hiện Tại</th>
                                                <th style="text-align: center">Cập Nhật Thông Tin</th>
                                                <th style="text-align: center">SendMail</th>
                                                <th style="text-align: center">Số Thành Tích </th>
                                                <th style="text-align: center">Số Kỷ Luật</th>
                                                <th style="text-align: center">Xếp Loại</th>
                                                <th style="text-align: center">Ngày Đánh Gía</th>
                                            ...
                                            <c:forEach var="m" items="${students}">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><a href="thanhtich/${m.id}.htm">Edit</a></td>
                                                    <td style="text-align: center"><a href="sendmail/${m.id}.htm">Send</a></td>
                                                    <td style="text-align: center">${m.thanhtich}</td>
                                                    <td style="text-align: center">${m.kyluat}</td>
                                                    <td><c:if test="${m.mark >5}">
                                                            Xuat Sac
                                                        </c:if>
                                                        <c:if test="${m.mark <5}">
                                                            Kem
                                                    ...
                                                    <td style="text-align: center">${m.ngaydanhgia}</td>
