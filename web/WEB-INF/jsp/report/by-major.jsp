                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center">Điểm thấp nhất</th>
                                            <th style="text-align: center">Điểm cao nhất</th>
                                            <th style="text-align: center">Điểm trung bình</th>
                                            <th style="text-align: center">Tổng Điểm Phòng Ban</th>
                                    ...
                                    <c:forEach var="a" items="${arrays}">
                                        <tr>
                                            ...
                                            <td style="text-align: center"><fmt:formatNumber value="${a[4]}" maxFractionDigits="2"/></td>
                                 ...
                                 <a href="major.htm"><button>Quay lại</button></a>
                                <!-- /.table-responsive -->
